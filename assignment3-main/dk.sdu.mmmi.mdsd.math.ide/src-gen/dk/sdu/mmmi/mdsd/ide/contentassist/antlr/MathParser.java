...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getParenthesisExpAccess().getGroup(), "rule__ParenthesisExp__Group__0");
			...
			builder.put(grammarAccess.getParenthesisExpAccess().getExpressionAssignment_1(), "rule__ParenthesisExp__ExpressionAssignment_1");
