...
@after {
	...
	(
		...
		{
			$current = $this_ParenthesisExp_2.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
entryRuleParenthesisExp returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getParenthesisExpRule()); }
	iv_ruleParenthesisExp=ruleParenthesisExp
	{ $current=$iv_ruleParenthesisExp.current; }
	EOF;

// Rule ParenthesisExp
ruleParenthesisExp returns [EObject current=null]
@init {
	enterRule();
}
@after {
