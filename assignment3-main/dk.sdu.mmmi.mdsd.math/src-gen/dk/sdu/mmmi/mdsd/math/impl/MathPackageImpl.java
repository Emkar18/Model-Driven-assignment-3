...
public class MathPackageImpl extends EPackageImpl implements MathPackage
{
   ...
   * @generated
   */
  private EClass parenthesisExpEClass = null;
   ...
   */
  @Override
  public EClass getParenthesisExp()
  {
    return parenthesisExpEClass;
  }
   ...
   */
  @Override
  public EReference getParenthesisExp_Expression()
  {
    return (EReference)parenthesisExpEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    parenthesisExpEClass = createEClass(PARENTHESIS_EXP);
    createEReference(parenthesisExpEClass, PARENTHESIS_EXP__EXPRESSION);
  ...
  public void initializePackageContents()
  {
    ...
    parenthesisExpEClass.getESuperTypes().add(this.getExpression());
    ...
    initEClass(parenthesisExpEClass, ParenthesisExp.class, "ParenthesisExp", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getParenthesisExp_Expression(), this.getExpression(), null, "expression", null, 0, 1, ParenthesisExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
