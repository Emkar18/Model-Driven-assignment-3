...
public class MathFactoryImpl extends EFactoryImpl implements MathFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case MathPackage.PARENTHESIS_EXP: return createParenthesisExp();
   ...
   */
  @Override
  public ParenthesisExp createParenthesisExp()
  {
    ParenthesisExpImpl parenthesisExp = new ParenthesisExpImpl();
