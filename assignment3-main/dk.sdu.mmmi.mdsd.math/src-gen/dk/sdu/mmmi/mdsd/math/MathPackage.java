...
public interface MathPackage extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link dk.sdu.mmmi.mdsd.math.impl.ParenthesisExpImpl <em>Parenthesis Exp</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see dk.sdu.mmmi.mdsd.math.impl.ParenthesisExpImpl
   * @see dk.sdu.mmmi.mdsd.math.impl.MathPackageImpl#getParenthesisExp()
   * @generated
   */
  int PARENTHESIS_EXP = 4;
   ...
   * @ordered
   */
  int PARENTHESIS_EXP__EXPRESSION = EXPRESSION_FEATURE_COUNT + 0;

  /**
   * The number of structural features of the '<em>Parenthesis Exp</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int PARENTHESIS_EXP_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for class '{@link dk.sdu.mmmi.mdsd.math.ParenthesisExp <em>Parenthesis Exp</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Parenthesis Exp</em>'.
   * @see dk.sdu.mmmi.mdsd.math.ParenthesisExp
   * @generated
   */
  EClass getParenthesisExp();

  /**
   * Returns the meta object for the containment reference '{@link dk.sdu.mmmi.mdsd.math.ParenthesisExp#getExpression <em>Expression</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Expression</em>'.
   * @see dk.sdu.mmmi.mdsd.math.ParenthesisExp#getExpression()
   * @see #getParenthesisExp()
   * @generated
   */
  EReference getParenthesisExp_Expression();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link dk.sdu.mmmi.mdsd.math.impl.ParenthesisExpImpl <em>Parenthesis Exp</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see dk.sdu.mmmi.mdsd.math.impl.ParenthesisExpImpl
     * @see dk.sdu.mmmi.mdsd.math.impl.MathPackageImpl#getParenthesisExp()
     * @generated
     */
    EClass PARENTHESIS_EXP = eINSTANCE.getParenthesisExp();
     ...
     * @generated
     */
    EReference PARENTHESIS_EXP__EXPRESSION = eINSTANCE.getParenthesisExp_Expression();
