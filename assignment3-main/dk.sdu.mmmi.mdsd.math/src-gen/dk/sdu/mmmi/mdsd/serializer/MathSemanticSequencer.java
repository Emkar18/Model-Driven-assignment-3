...
public class MathSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == MathPackage.eINSTANCE)
			...
			case MathPackage.MULT:
				...
				return; 
			case MathPackage.PARENTHESIS_EXP:
				sequence_ParenthesisExp(context, (ParenthesisExp) semanticObject); 
				return; 
	...
	/**
	 * Contexts:
	 *     Exp returns ParenthesisExp
	 *     Exp.Plus_1_0_0_0 returns ParenthesisExp
	 *     Exp.Minus_1_0_1_0 returns ParenthesisExp
	 *     Factor returns ParenthesisExp
	 *     Factor.Mult_1_0_0_0 returns ParenthesisExp
	 *     Factor.Div_1_0_1_0 returns ParenthesisExp
	 *     Primary returns ParenthesisExp
	 *     ParenthesisExp returns ParenthesisExp
	 *
	 * Constraint:
	 *     expression=Exp
	 */
	protected void sequence_ParenthesisExp(ISerializationContext context, ParenthesisExp semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MathPackage.Literals.PARENTHESIS_EXP__EXPRESSION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MathPackage.Literals.PARENTHESIS_EXP__EXPRESSION));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getParenthesisExpAccess().getExpressionExpParserRuleCall_1_0(), semanticObject.getExpression());
		feeder.finish();
	}
